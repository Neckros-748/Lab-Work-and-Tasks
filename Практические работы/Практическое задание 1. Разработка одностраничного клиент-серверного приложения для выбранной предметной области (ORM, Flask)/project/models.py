...
class Genre(db.Model):
	...
	games = db.relationship('VideoGame', back_populates="genre_rel", cascade="all, delete")
...
class Platform(db.Model):
	...
	identifier    = db.Column('ID',       db.Integer, primary_key=True)
	name          = db.Column('Название', db.String(50), nullable=False)
	sales = db.relationship('SaleGame', back_populates="platform_rel", cascade="all, delete")
...
class VideoGame(db.Model):
	...
	sales     = db.relationship('SaleGame', back_populates="game_rel", cascade="all, delete")
